...
class CppoLstmAgent(MujocoLstmAgent):
    ...
    def initialize(self, *args, **kwargs):
        ...
        self.beta_r_model = self.ModelCls(**self.model_kwargs, **self.env_model_kwargs)
        self.beta_c_model = self.ModelCls(**self.model_kwargs, **self.env_model_kwargs)
    ...
    def beta_dist_infos(self, observation, prev_action, prev_reward, init_rnn_state):
        ...
        return buffer_to(
            (
                DistInfoStd(mean=r_mu, log_std=r_log_std),
